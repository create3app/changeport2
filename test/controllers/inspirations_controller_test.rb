...
class InspirationsControllerTest < ActionController::TestCase
  ...
  test "should create inspiration" do
    assert_difference('Inspiration.count') do
      post :create, inspiration: { create: @inspiration.create, destroy: @inspiration.destroy, friend_id: @inspiration.friend_id, user_id: @inspiration.user_id }
    end
  ...
  test "should update inspiration" do
    patch :update, id: @inspiration, inspiration: { create: @inspiration.create, destroy: @inspiration.destroy, friend_id: @inspiration.friend_id, user_id: @inspiration.user_id }
    assert_redirected_to inspiration_path(assigns(:inspiration))
  end
